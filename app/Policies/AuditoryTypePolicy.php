...
class AuditoryTypePolicy
{
    ...
    {
        return $user->can('auditoryType show');
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, AuditoryType $auditoryType)
    {
        return $user->can('auditoryType delete');
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, AuditoryType $auditoryType)
    {
        return $user->can('auditoryType delete');
    }
}
