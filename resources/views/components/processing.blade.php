@props(['className', 'document'])
<div class="flex gap-2 items-center">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 218 208" id="el_QQ9wlw0JC" class="{{ $className }}">
        <style>
            @-webkit-keyframes el_Qlda4JMGnZ_J0Dx98qCd_Animation {
                0% {
            ...
            @keyframes el_Qlda4JMGnZ_J0Dx98qCd_Animation {
                0% {
                    -webkit-transform: rotate(0deg);
                    transform: rotate(0deg);
                }
            ...
            @-webkit-keyframes el_mVFW-woxV8_fJA8hySOs_Animation {
                0% {
                    -webkit-transform: rotate(0deg);
                    transform: rotate(0deg);
                }
            ...
            @keyframes el_mVFW-woxV8_fJA8hySOs_Animation {
                0% {
                    -webkit-transform: rotate(0deg);
                    transform: rotate(0deg);
                }
            ...
            #el_mVFW-woxV8_fJA8hySOs {
                -webkit-animation-name: el_mVFW-woxV8_fJA8hySOs_Animation;
